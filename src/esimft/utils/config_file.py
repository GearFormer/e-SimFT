...
def config():
    ...
    parser.add_argument('--req_name', type=str, default="speed")
    ...
    parser.add_argument('--gf_data_req_start_idx', type=int, default=2)
    parser.add_argument('--gf_data_req_end_idx', type=int, default=9)
    parser.add_argument('--gf_data_req_speed_idx', type=int, default=2)
    parser.add_argument('--gf_data_req_pos_idx', type=int, nargs="+", default=[3, 4, 5])
