...
def config():
    ...
    parser.add_argument('--aug_data_type', type=str, default="pref", choices=["pref", "pareto_test", "simft_test"])
    ...
    parser.add_argument('--simft_test_aug_data', type=str, default="/app/data/esimft_data/simft_test_aug.pkl")
    parser.add_argument('--pareto_problems_data', type=str, default="/app/data/esimft_data/pareto_problems.pkl")
    parser.add_argument('--pareto_samples_folder', type=str, default="/app/data/esimft_data/pareto_samples")
    ...
    parser.add_argument('--gf_data_req_output_motion_dir', type=int, default=8)
    parser.add_argument('--gf_data_req_output_motion_sign', type=int, default=9)
    parser.add_argument('--gf_data_req_price', type=int, default=10)
    parser.add_argument('--gf_data_req_bb_volume', type=int, default=11)
