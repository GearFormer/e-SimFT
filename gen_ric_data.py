...
if __name__ == "__main__":
    ...
    data = pd.read_pickle("esimft_data/pref_train_nr.pkl")
    ...
    for i in range(0, data_size):
        ...
        req_input_batch = batch_size * [req_input]
    ...
    df.to_pickle("esimft_data/ric_train.pkl")
    df = pd.DataFrame(val_dataset, columns=['req_input', 'seq', 'new_req', 'weights'])
    df.to_pickle("esimft_data/ric_val.pkl")
